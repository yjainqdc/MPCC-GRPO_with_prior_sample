...
if __name__ == "__main__":
    ...
    parser.add_argument("--pretrained_model", type=str, default="/sshfs/pretrains/Qwen/Qwen2-VL-2B-Instruct/", help="Pretrained model to use.")
