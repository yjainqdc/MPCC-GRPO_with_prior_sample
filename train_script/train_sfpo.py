...
import json
from dataset import get_med_dataset, get_mask_dataset, get_coco_dataset,get_coco_sfpo_dataset
...
from sfpo_trainer import Qwen2VLSFPOTrainer  # third-party trainer from open-R1
import re
...
output_dir = "./outputs/Qwevl-Instruct-GRPO-Coma_sfpo"
run_name = "Qwen-vl-SFPO"
###########################################
...
dataset_train = get_coco_sfpo_dataset()
